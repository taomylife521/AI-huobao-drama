...
- **色彩美学逻辑**：使用 **"温和的高饱和调色盘 (Muted Vibrant Palette)"**。色彩鲜艳但并不刺眼，通常带有一定的 **粉质感 (Pastel undertone)**。色彩分布遵循"主次分明"原则，利用大面积的自然底色（如森林绿、泥土褐）衬托主体鲜明的服饰色彩。
...
- **Color Aesthetic Logic**: Uses a **"Muted Vibrant Palette."** Colors are vivid but not piercing, usually with a **pastel undertone**. Color distribution follows a "primary-secondary" principle, using large areas of natural base colors (forest green, earth brown) to set off the bright colors of the character's outfit.
